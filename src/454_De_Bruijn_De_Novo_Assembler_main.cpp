...
// TODO: add support for fasta files
//
...
int main(int argc,char*argv[]){
	...
	int minimumCoverage=2;
	m_cout<<" -minimumCoverage     default: "<<minimumCoverage<<" (should be at least 2)"<<endl;
	int wordSize=25;
	m_cout<<" -wordSize            default: "<<wordSize<<" (maximum: 31)"<<endl;
	int minimumQuality=20;
	m_cout<<" -minimumQuality      default: "<<minimumQuality<<" (not very important, minimum coverage does the job alright!)"<<endl;
	...
	m_cout<<" windowSize = "<<windowSize<<endl;
	m_cout<<" useCache = "<<useCache<<endl;
